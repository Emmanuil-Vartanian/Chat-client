...
const getSearchValueState = state => state.entities.group.searchUsers.value
...
export const getSearchValueSelector = createSelector([getSearchValueState], value => value)
